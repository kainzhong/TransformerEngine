...
class HybridQuantizer : public Quantizer {
  public:
    explicit HybridQuantizer(const py::handle& quantizer);
  
    NVTEScalingMode get_scaling_mode() const override { return NVTE_1D_SCALING_HYBRID; }
