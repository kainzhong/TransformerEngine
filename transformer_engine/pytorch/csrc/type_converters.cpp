...
TensorWrapper NVTETensorFromHybridTensor(py::handle tensor, Quantizer *quantizer) {
  auto ret = TensorWrapper(NVTE_1D_SCALING_HYBRID);
  ...
  NVTE_CHECK(rowwise_usage || columnwise_usage, "No data found for Hybrid Tensor.");
